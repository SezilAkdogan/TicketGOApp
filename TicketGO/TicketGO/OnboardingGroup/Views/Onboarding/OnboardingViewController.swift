...
class OnboardingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        slides.append(OnboardingSlide(title: "Easy Search", description: "Searching for TicketGO is very easy! Simply select the cities and dates you want to travel, and then view all the options with just a few taps.", image: UIImage(named: "onboardSecond")!))
